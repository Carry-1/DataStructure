...
运行结果：
```
E:\Personal Blog\DataStructure>cd "e:\Personal Blog\DataStructure\Calculator\" && g++ calculator-review.cpp -o calculator-review && "e:\Personal Blog\DataStructure\Calculator\"calculator-review
please input infix expression
3 + 6 * 9 - 4 + 8
the output is:
61.00
```
